...
const TaskForm = () => {
    ...
    return (
        ...
        <Form className='task-form' onSubmit={handleSubmit}>
            <input value={titulo} onChange={(e) => setTitulo(e.target.value)} className='task-title' placeholder='Título...' type="text" />
            <textarea value={descricao} onChange={(e) => setDescricao(e.target.value)} className='task-description' placeholder='Descrição...' type="text" />
